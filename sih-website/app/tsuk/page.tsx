...
export default function TsukMonastery() {
  ...
  const images = [
    { src: '/tsuk/tsuk 1.avif', alt: 'Tsuk 1' },
    { src: '/tsuk/tsuk 2.jpg', alt: 'Tsuk 2' },
    { src: '/tsuk/tsuk 3.jpg', alt: 'Tsuk 3' },
  ];
          ...
          <Reveal delay={0.5}>
            <div className="flex-1 flex flex-col gap-6 text-amber-100 pl-10 mt-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <div className="text-xl font-semibold tracking-wide" style={{ fontFamily: 'serif' }}>Tsuk, East Sikkim</div>
        ...
        <div className="flex">
          ...
          <Reveal delay={0.4}>
            <p className="text-lg text-amber-50 leading-relaxed mb-6">
              Tsuk Monastery, the most significant Karma Kagyu institution in India, stands as a beacon of Buddhist spirituality and architectural brilliance. Built in 1966 CE, this magnificent structure commands breathtaking views of the Kanyam valley and the surrounding Himalayan peaks from its elevated location in East Sikkim.
            </p>
          </Reveal>
          <Reveal delay={0.6}>
